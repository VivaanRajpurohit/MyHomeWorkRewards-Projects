					...
					<div class="col-lg-3">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<li class="list-group-item" style="padding:10px 0px 0px 0px;"><a href="organized_counting.php">Organized Counting</a></li>
								<li class="list-group-item" style="padding:10px 0px 0px 0px;"><a href="probability_fundamentals.php">Probability Rules</a></li>
								</ul>
							</div>
						</div>
						<div class="panel panel-default">
